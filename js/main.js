...
/*
    multi-line comment on javascript

    -- Variable Declaration in Javascript --
    Primitive data type: string, number, Boolean, Undefined, Null
    Object types: Objects, Arrays, Function
*/


// Variable Declaration
// use VAR tp declare a gloabally-scoped or function-scoped variable
...
// console.log() is equivlent to python's print() function
console.log(myName);
console.log(typeof myName);

// Strings can use ''. "", ``. The tick marks(``) have a special behaviorto format string
// Tick Marks +${} is equivolent to f"{} * interpolated string
